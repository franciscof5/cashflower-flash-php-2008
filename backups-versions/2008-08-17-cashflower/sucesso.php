						...
						<table cellspacing="5" cellpadding="10">
							<tr valign="top">
								...
								<td width="290">
									...
									<p>Antes de começar a utilizar o sistema, lembre-se	de	que	este	se	encontra	em	fase	de	testes, portanto não é possível garantimos a estabilidade deste nem dos dados nele contidos durante o período de testes.</p>
									<p>Ainda <strong>não será enviado</strong> um email de confirmação. Pode utilizar o sistema na <strong>fase de testes</strong> sem a necessidade de confirmar o email.</p>
									<p>O email de confirmação será enviado assim que a fase de testes acabar.</p>
									<p><a href="index.php">Voltar para página inicial</a></p></td>
								<td>								</td>
							</tr>
						</table>
					</td>
