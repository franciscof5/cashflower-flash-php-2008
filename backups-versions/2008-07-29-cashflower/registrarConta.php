...
if($cadastramentoCorreto_==true) {
	...
	//
	$queryRelacionalString = 'INSERT INTO `relusercont` (`relUserContID`, `userID`, `contaID`) VALUES (\'\', "'.$_SESSION["userID"].'", "'.$queryContaArray["contaBancariaID"].'");';
...
$queryBancosString = 'SELECT `bancoNome`,`bancoID` FROM `banco`;';
					...
					<td>
						...
						<table cellspacing="5" cellpadding="10" width="100%">
							...
							<tr valign="top">
								...
								<td><h2>Várias Contas Bancárias:</h2>
								<p>-Somente o Cash Flower permite o registro de v&aacute;rias contas banc&aacute;rias, proporcionando o controle que voc&ecirc; precisa de suas finan&ccedil;as.</p>
								<p>-Facilite sua vida, utiliza a descrição da conta para se organizar, é um item essencial quando se trabalha com muitas contas.</p>
								<p>-Verifique atentamente a lista de bancos, prefira sempre escolher o banco na lista a registrar um banco novo.</p>
								</td>
							</tr>
						</table>
					</td>
