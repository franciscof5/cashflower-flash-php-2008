...
if($cadastramentoCorreto_ == true and $email!=NULL) {	
	...
	$db = mysql_select_db("cash_flower", $conexao);
	
	//$queryInsercaoString = 'INSERT INTO `cash_flower`.`usuario` (`userID`, `email`, `senha`, `nome`, `nascimento`, `emailValidado`) VALUES (NULL, "'.$email.'", "'.$senha.'", "'.$nome.'", "'.$nascimento.'", \'0\');';
	
	$queryInsercaoString = 'INSERT INTO `cash_flower`.`usuario` (`userID`, `email`, `senha`, `nome`, `nascimento`, `sexo`, `pais`, `estado`, `cidade`, `escolaridade`, `utilizacao`, `cometario`, `dataCadastro`, `emailValidado`) VALUES (NULL, "'.$email.'", "'.$senha.'", "'.$nome.'", "'.$nascimento.'", "'.$sexo.'", "'.$pais.'", "'.$estado.'", "'.$cidade.'", "'.$escolaridade.'", "'.$utilizacao.'", "'.$comentario.'", NOW(), \'0\');';
